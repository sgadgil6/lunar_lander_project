...
ax.set_title("Comparison of Different Hidden Neurons")
plt.plot(episodes_64, rewards_64, 'r', label='DQN 64')
plt.plot(episodes_128, rewards_128, 'g', label='DQN 128')
plt.plot(episodes_256, rewards_256, 'b', label='DQN 256')
ax.set_xlabel("Iterations")
ax.set_ylabel("Average Reward")
ax.legend(loc='best')
plt.savefig('dqn_plot_original.jpg')
plt.show()